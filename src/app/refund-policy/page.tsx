          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-600 mb-6">
                At Alburaq Express, we strive to provide the highest quality delivery and logistics services. 
                This refund policy outlines the circumstances under which refunds may be issued and the 
                process for requesting them.
              </p>

              <h2 className="text-2xl font-bold text-gray-900 mb-6">2. Service Cancellation</h2>
              <p className="text-gray-600 mb-6">
                You may cancel your service request under the following conditions:
              </p>
              <ul className="list-disc pl-6 text-gray-600 mb-8">
                <li>Before the pickup has been initiated</li>
                <li>Due to circumstances beyond our control (weather, natural disasters)</li>
                <li>If we are unable to fulfill your request due to operational issues</li>
              ...
              <ul className="list-disc pl-6 text-gray-600 mb-8">
                <li><strong>Service Not Provided:</strong> If we fail to provide the service as agreed</li>
                <li><strong>Significant Delay:</strong> Delays exceeding 48 hours from the promised delivery time</li>
                <li><strong>Damaged Goods:</strong> Items damaged during transit due to our negligence</li>
                <li><strong>Wrong Delivery:</strong> Delivery to incorrect address due to our error</li>
                <li><strong>Service Cancellation:</strong> Cancellation within the allowed timeframe</li>
              </ul>

              <h2 className="text-2xl font-bold text-gray-900 mb-6">4. Non-Refundable Services</h2>
              <p className="text-gray-600 mb-6">
              ...
              <ol className="list-decimal pl-6 text-gray-600 mb-8">
                <li>Contact our customer service within 7 days of the service date</li>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">7. Partial Refunds</h2>
              <p className="text-gray-600 mb-6">
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <p className="text-gray-700">
                  <strong>Email:</strong> refunds@alburaqexpress.com<br/>
              ...
              <div className="mt-8 p-6 bg-blue-50 rounded-xl">
                ...
                <p className="text-blue-800">
                  ...
                  For specific cases not covered in this policy, please contact our customer service team.
                </p>
              </div>
            </div>
          </div>
