  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formRef.current) {
        ...
        const thankYouResult = await emailjs.sendForm(
          serviceId,
          thankYouTemplateId,
          formRef.current,
          userId
        ...
        if (
          notificationResult.status === 200 &&
          thankYouResult.status === 200
        ) {
    ...
    <section id="contact" className="bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-blue-600 to-blue-700 mx-auto rounded-full"></div>
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-6 sm:p-8 lg:p-12 text-white">
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm sm:text-base">
                      Al Salam Tower, 10th Floor Office R10, Abu Dhabi
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/20">
                <h4 className="font-semibold text-lg sm:text-xl mb-4 sm:mb-6">
                  Follow Us
                </h4>
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 text-white rounded-xl flex items-center justify-center hover:bg-white/30 transition-all duration-300 backdrop-blur-sm hover:scale-110"
                  >
                    <svg
            ...
            <div className="p-6 sm:p-8 lg:p-12 bg-white">
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:from-gray-400 disabled:to-gray-500 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-lg sm:rounded-xl transition-all duration-300 text-base sm:text-lg transform hover:scale-105 hover:shadow-lg disabled:transform-none disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
