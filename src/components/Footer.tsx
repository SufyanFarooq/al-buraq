        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 relative">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Alburaq Cargo LLC is your trusted partner for seamless logistics
              and delivery services across UAE. We provide last-mile delivery,
              supply chain management, and comprehensive logistics solutions to
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-blue-800 rounded-lg flex items-center justify-center hover:bg-blue-800 transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          <div className="lg:col-span-1 relative z-10">
            ...
            <div className="relative h-48 rounded-xl overflow-hidden shadow-lg bg-gray-800">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3630.5893438404723!2d54.3707626!3d24.499681600000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e674cfedf9ecb%3A0x4b962449bcd2e098!2sAl%20Salam%20Tower!5e0!3m2!1sen!2s!4v1753790022704!5m2!1sen!2s"
                width="600"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Alburaq Cargo Delivery Service LLC.
              All rights reserved.
            </div>
